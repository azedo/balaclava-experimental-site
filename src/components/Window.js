    ...
    return (
      <div data-id={this.props.index} className={`window window--${this.props.windowType}`} style={{left: this.props.position[0] + 'px', top: this.props.position[1] + 'px', position: 'absolute'}}>
        <div className="window-top">
          <div className="window-top__controls">
            <a href="#" className="window-top__btn" onClick={(e) => this.props._toggleMinMaxWindow(e)}>_</a>
            <a href="#" className="window-top__btn" onClick={(e) => this.props._deleteWindow(e, this.props.index)}>x</a>
          </div>
        </div>
        <div className="window-content">
          <div className="window-content__img">
            <img src={this.props.content} alt="Project name" />
          </div>
          <div className="window-content__text">
            <h3>Who they are</h3>
